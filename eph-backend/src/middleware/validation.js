...
//   verifyEmail: [
//     // Accept token from either body or query parameters
//     body('token')
//       .optional()
//       .isLength({ min: 10 })
...
//           success: false,
//           message: 'Validation failed',
//           errors: [{ field: 'token', message: 'Verification token is required' }]
//         });
//       }
      
//       // Set the token in req.body for consistent access in controller
//       if (queryToken && !bodyToken) {
//         req.body.token = queryToken;
//       }
...
//   // Magic token consumption validation
//   consumeMagic: [
//     body('token')
//       .notEmpty()
...
//     body('source_type')
//       .isIn(['company', 'hackathon', 'university'])
