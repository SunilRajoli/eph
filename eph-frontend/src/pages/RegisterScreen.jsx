...
const RegisterScreen = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: theme?.gradient }} // fallback if you keep ThemeContext
    >
      <div className="mx-auto w-full max-w-lg bg-slate-900/70 backdrop-blur-md p-5 md:p-7 rounded-2xl border border-slate-700/60 shadow-2xl">
        {/* Top bar INSIDE the card */}
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <button
              onClick={() => navigate(-1)}
              className="text-slate-200/90 hover:text-white transition-colors text-2xl"
              type="button"
              aria-label="Go back"
            >
              ←
            </button>
            <h1 className="text-slate-50 text-2xl font-bold">Register</h1>
          </div>
          {selectedRole && (
            <div className="bg-slate-800/70 border border-slate-700 px-3 py-1.5 rounded-full">
              <span className="text-slate-200 font-semibold text-xs md:text-sm tracking-wide">
        ...
        <div className="flex items-center gap-3 mb-5">
          <div className="w-12 h-12 bg-cyan-500/15 rounded-xl border border-cyan-500/30 flex items-center justify-center">
            <UserIcon className="w-6 h-6 text-cyan-300" />
          </div>
          <h2 className="text-slate-100 text-xl font-semibold">Create your account</h2>
        </div>
        ...
        ">
          ...
          {/* Error */}
          {errorMsg && (
            <div className="bg-red-500/10 border border-red-500/30 text-red-300 text-sm p-3 rounded-lg whitespace-pre-line">
              {errorMsg}
            </div>
          )}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <button
            ...
            className="h-12 px-3 bg-slate-800/60 hover:bg-slate-800 border border-slate-700/70 rounded-lg transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
          >
            <GoogleIcon className="w-5 h-5 text-slate-200" />
